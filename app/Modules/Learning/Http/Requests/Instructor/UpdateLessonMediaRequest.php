...
use App\Modules\Learning\Http\Requests\Lesson\UpdateLessonMediaRequest as BaseRequest;

class UpdateLessonMediaRequest extends BaseRequest
{
    public function bodyParameters(): array
    {
        return [
            'media_type' => [
                'description' => 'Tipo de mídia da aula própria.',
                'example' => 'video',
            ],
            'provider' => [
            ...
            'metadata' => [
                'description' => 'Payload JSON permitido para a metadata da mídia.',
                'example' => ['quality' => 'hd'],
            ],
        ];
    }
