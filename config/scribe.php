...
return [
    ...
    'description' => 'API RESTful para plataforma EAD multi-tenant',

    // Text to place in the "Introduction" section, right after the `description`. Markdown and HTML are supported.
    'intro_text' => <<<'INTRO'
            Esta documentação descreve todos os endpoints da API RESTful do sistema EAD.
    ...
    'auth' => [
        ...
        'extra_info' => 'Utilize o endpoint `/api/v1/auth/login` para obter o token de autenticação.',
    ],
